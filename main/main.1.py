...
A, b = helperFunction.getMatrices(DEFAULT_TIME)
...
A, b, prediction = linUCB(A, b, [], context_pool, alpha, context_size)
...
while Continue:
    ...
    helperFunction.saveMatrices(A, b, DEFAULT_TIME)
    #save the current matrices A, b according to time
